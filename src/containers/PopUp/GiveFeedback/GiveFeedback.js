  ...
  return (
    <CustomModal visible={isModalVisible} togglePopup={onToggle}>
      <View style={[styles.viewStyle1,{backgroundColor:colors.popup}]}>
        ...
        <Text style={[styles.txtStyle2,{color:colors.title}]}>Rate Your Experience</Text>
        ...
        <SearchBar
          ...
          containerStyle={[styles.containerheight,{backgroundColor:colors.filterinput,borderColor:colors.line}]}
